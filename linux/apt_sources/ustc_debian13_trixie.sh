...
# ==============================================================================
# 脚本功能：Debian 13 (Trixie) 更换中国科学技术大学源 (增加用户权限检测)
# ==============================================================================
...
# 2. 写入中国科学技术大学源配置到新文件
echo -e "${YELLOW}正在写入中国科学技术大学源配置到 /etc/apt/sources.list.d/ustc.list ...${NC}"
$SUDO_CMD tee /etc/apt/sources.list.d/ustc.list <<'EOF'
