...
# ==============================================================================
# 脚本功能：Debian 13 (Trixie) 更换清华源 (增加用户权限检测)
# ==============================================================================
...
# 2. 写入清华源配置到新文件
echo -e "${YELLOW}正在写入清华源配置到 /etc/apt/sources.list.d/tsinghua.list ...${NC}"
$SUDO_CMD tee /etc/apt/sources.list.d/tsinghua.list <<'EOF'
